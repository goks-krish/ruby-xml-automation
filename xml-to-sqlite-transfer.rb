...
create_table_query = "CREATE TABLE search_db_column_names (pk INTEGER PRIMARY KEY, display_name TEXT, column_name TEXT)"
  create_table_command = "sqlite3.exe #{SQL_FILE_NAME} \"#{create_table_query}\""
...
searches.each do |search_category|
  ...
  sql_command = "sqlite3.exe #{SQL_FILE_NAME} \"#{sql_query}\""
  system sql_command
end
...
searches.each do|search|
  ...
  create_index_command = "sqlite3.exe #{SQL_FILE_NAME} \"#{create_index_query}\""
